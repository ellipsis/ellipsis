...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
    ...
    -- launch dmenu
    , ((modMask,               xK_r     ), spawn "exe=`dmenu_run -fn 'dina-8' -nb '#000000' -nf '#FFFFFF' -sb '#7C7C7C' -sf '#CEFFAC'` && eval \"exec $exe\"")
...
myLayout = avoidStruts (tiled ||| Mirror tiled ||| tabbed shrinkText myTabConfig ||| Grid ||| Full ||| spiral (6/7))
  where
